...
def load_data(file_path = r"/Users/byzeedmollah_/python projects/imdb_top_1000.csv"):
...
def display_recommendations(recs, name):
    print(Fore.YELLOW + f"\n🍿 AI-Analysed Movie Recommends for {name}:")
...
def handle_ai(name):
    ...
    while True:
        ...
        try:
            ...
            print(Fore.RED + "Invaid input. Try again.\n")
